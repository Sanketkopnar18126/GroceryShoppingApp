  ...
  const onSubmit = () => {
    ...
    signInWithEmailAndPassword(auth, details.email, details.password)
      ...
      .catch((error) => {
        ...
        toast.error(' Unvalid data pls Sign Up !', {
          position: "top-right",
          autoClose: 1000,
          hideProgressBar: false,
          closeOnClick: true,
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    className="b border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5    dark:focus:ring-blue-500 dark:focus:border-blue-500"
